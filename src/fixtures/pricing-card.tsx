...
export const PricingCard = forwardRef<HTMLDivElement, PricingCardProps>(
  ({ stage, ctaRef }, ref) => {
    ...
    return (
      <div ref={ref} className="w-full max-w-[340px] rounded-[24px] border border-white/10 bg-[#101419] p-6 shadow-2xl shadow-black/40">
        <div className="flex items-start justify-between gap-4">
          <div>
            <div className="mb-1 text-[10px] font-bold tracking-[0.18em] text-sky-400">PRO PLAN</div>
          ...
          <button
            ...
            className="grid h-9 w-9 place-items-center rounded-xl border border-white/10 bg-white/[0.04] text-zinc-400"
          >
        ...
        <button
          ...
          type="button"
          style={ctaStyle}
          className="mt-7 w-full rounded-xl px-4 py-3 text-sm font-bold shadow-lg shadow-black/20 transition-colors"
        >
          Get Pro
        </button>
      </div>
